...
const networks = [
  ...
  {
    name: "Tesnet (BSC)",
    routerAddr: "0x1b81D678ffb9C0263b24A97847620C99d213eB14",
    url: "bsc-testnet",
...
class Wallet {
  ...
  createMetamaskWallet(userId, publicKey) {
    ...
    let bsctest_assets = "0x0000000000000000000000000000000000001010,0xeD24FC36d5Ee211Ea25A80239Fb8C4Cfd80f12Ee";
    return {
      user_id: userId,
      publickey: publicKey,
      privatekey: "",
